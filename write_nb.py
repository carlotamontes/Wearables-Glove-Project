...
cells.append({
    ...
    "source": [
        ...
        "N_CYCLES  = 5       # default number of cycles\n",
        "STRAIN    = 0.5\n",
        "MA_WINDOW = 50\n",
        "\n",
        "sensors = {\n",
        ...
        "CUTOFF_S        = {\"460k\": 170}   # cut data after this many seconds\n",
        "N_CYCLES_SENSOR = {\"460k\": 4}     # use a different number of cycles for specific sensors\n",
        "\n",
        "dfs = {}\n",
...
cells.append({
    ...
    "source": [
        ...
        "\n",
        "    n_cyc  = N_CYCLES_SENSOR.get(label, N_CYCLES)  # use override if defined\n",
...
cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## Cycles plot"]})
...
cells.append({
    ...
    "source": [
        ...
        "    title_suffix = f\" ({n_cyc} cycles)\" if n_cyc != N_CYCLES else \"\"\n",
        "    ax.set_title(label + title_suffix, fontsize=11, fontweight=\"bold\")\n",
...
cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## GF per cycle"]})
...
cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## Summary table"]})
...
path = r"C:\Users\carlo\OneDrive - Universidade de Lisboa\Documents\GitHub\Wearables-Glove-Project\plotting_data.ipynb"
